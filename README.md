...
```bash
curl http://127.0.0.1:8180/json/8.8.8.8
```
...
```bash
curl "http://127.0.0.1:8080/json/8.8.8.8?fields=ip,country_name,city_name,asn"
```
...
**⭐ 如果这个项目对你有帮助，请给个Star支持一下！**#   I P - l o o k u p - t o o l 
 
 